...
latex_documents = [
    (master_doc, 'noiseprotocol.tex', 'noiseprotocol Documentation',
     'Piotr Lizonczyk', 'manual'),
]
...
man_pages = [
    (master_doc, 'noiseprotocol', 'noiseprotocol Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'noiseprotocol', 'noiseprotocol Documentation',
     author, 'noiseprotocol', 'One line description of project.',
     'Miscellaneous'),
]
